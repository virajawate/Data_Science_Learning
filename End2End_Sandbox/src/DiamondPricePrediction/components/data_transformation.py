...
This code transforms the data in
machine friendly way (eg:[-1,1])
...
class Data_Transformation:
    ...
    def initialize_data_transformation(self, train_path, test_path):
        try:
            ...
            logging.info("Preprocesing the pickle file saved.")
            
            return (train_arr, test_arr)
        
        except Exception as e:
            logging.info("Exception occured in the initiating_data_transformation.")
            raise CustomException(e, sys)
